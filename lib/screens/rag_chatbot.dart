...
class _RagChatScreenState extends State<RagChatScreen> {
  ...
  Future<void> _initializeRAG() async {
    try {
      ...
      final systemPrompt = """
        You are 'Juno', a friendly medical assistant for 'TeenHealth'.
        RULES:
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                // Show Typing Indicator as last item if sending
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              color: backgroundColor, // Match background for seamless look
            ),
            child: Row(
              children: [
                Expanded(
  ...
  // Animated Bubble without PFP
  Widget _buildMessageBubble(ChatMessage msg, Color surfaceColor, Color accentColor) {
    final isUser = msg.isUser;
    
    // TweenAnimationBuilder creates a "slide-in + fade-in" effect for every new message
      ...
      builder: (context, double value, child) {
        return Opacity(
          ...
          child: Transform.translate(
            offset: Offset(0, 20 * (1 - value)), // Slide up from 20px down
            child: child,
          ),
        );
      },
          ...
          child: isUser 
            ...
            : MarkdownBody(
                ...
                styleSheet: MarkdownStyleSheet(
                  ...
                  a: GoogleFonts.poppins(color: accentColor, fontWeight: FontWeight.bold, decoration: TextDecoration.underline), // Link color matches accent
                ),
              ),
        ),
      ),
